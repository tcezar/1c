...
SRC_URI="mirror://postgresql/source/v${PV}/postgresql-${PV}.tar.bz2
		 https://daks-overlay.googlecode.com/files/postgresql-patches-9.1-r1.tbz2
		 https://daks-overlay.googlecode.com/files/postgresql-initscript-2.1.1.tbz2
		 http://daks-overlay.googlecode.com/files/1c_postgresql-9.1.tar.xz"
...
src_prepare() {
	...
	if use 1c ; then
		epatch "${WORKDIR}/1c_postgresql-9.1/1c_postgresql-9.1-logging.patch" \
			"${WORKDIR}/1c_postgresql-9.1/1c_postgresql-9.1-prefer-ncurses.patch" \
			"${WORKDIR}/1c_postgresql-9.1/1c_postgresql-9.1-FULL_91-0.21.patch" \
			"${WORKDIR}/1c_postgresql-9.1/1c_postgresql-9.1-configs-server.patch" \
			"${WORKDIR}/1c_postgresql-9.1/1c_postgresql-9.1-applock.patch" \
			"${WORKDIR}/1c_postgresql-9.1/1c_postgresql-9.1-online_analyze-0.8.patch" \
			"${WORKDIR}/1c_postgresql-9.1/1c_postgresql-9.1-plantuner.patch"
	fi
